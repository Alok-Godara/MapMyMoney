...
import { Company, Expense, Fund } from '../types';
import { 
  getCompanyById,
  getCompanyExpenses, 
  getCompanyFunds, 
...
const CompanyDetail: React.FC = () => {
  ...
  const isOwner = user && company && user.id === company.ownerId;
  ...
  const loadCompanyData = async () => {
    ...
    try {
      ...
      const expenseData = getCompanyExpenses(companyId);
      const fundData = getCompanyFunds(companyId);
  ...
  const handleReimburse = async (expenseId: string, amount: number) => {
    if (!companyId || !user) return;

    try {
      reimburseExpense(companyId, expenseId, amount, user.id);
      loadCompanyData();
    } catch (error) {
      ...
      <div className="space-y-6">
        ...
        {activeTab === 'overview' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-gray-800 rounded-lg p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-400">Available Funds</p>
              ...
              <div className="bg-gray-800 rounded-lg p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-400">Reimbursed</p>
                    <p className="text-2xl font-bold text-white">
            ...
            {/* Recent Expenses */}
            <div className="bg-gray-800 rounded-lg p-6">
              <h3 className="text-lg font-medium text-white mb-4">Recent Expenses</h3>
                ...
                <div key={expense.id} className="bg-gray-800 rounded-lg p-6">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-gray-400 mb-2">{expense.description}</p>
